...
class LogRequest:
    ...
    def __init__(
        self, request_type="", urgency_level="", property_address="", description="",
        submitted_date=None, status="pending", log_request_id=None, archive=False
    ):
        """Initializer/object constructor.
        Args:
            request_type  (str): Type of the request
            urgency_level  (str): Urgency level of the request
            property_address (str): Address of the property related to the request
        ...
        self.submitted_date = submitted_date if submitted_date else datetime.now()
